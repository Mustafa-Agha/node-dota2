...
var loginToSteam = function (done) {
  ...
  steamUser.on("loggedOn", function onSteamLogOn(logonResp) {
...
var invertKMsgTypeID = function () {
  ...
  var calculated_msg_type_id = dota2._getMessageName(
    dota2.schema.lookupEnum("EDOTAGCMsg").values.k_EMsgClientToGCGetProfileCard
  );
